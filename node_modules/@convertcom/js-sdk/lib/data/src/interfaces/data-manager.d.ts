 ...
 * License Apache-2.0
 */
import { Entity, ConfigResponseData, IdentityField, BucketedVariation, StoreData, VisitorSegments, ConfigExperience, BucketingAttributes, LocationAttributes, GoalData } from '../../../types';
import { DataStoreManagerInterface } from './data-store-manager';
import { BucketingError, ConversionSettingKey, RuleError } from '../../../enums';
