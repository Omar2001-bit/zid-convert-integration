(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ConvertSDK = {}));
    ...
    ***************************************************************************** */
    ...
    class ApiManager {
        ...
        releaseQueue(reason) {
            ...
            return this.request('post', {
                ...
                (_b = (_a = this._eventManager) === null || _a === void 0 ? void 0 : _a.fire) === null || _b === void 0 ? void 0 : _b.call(_a, exports.SystemEvents.API_QUEUE_RELEASED, {
                    reason: reason,
                    result: result,
                ...
                this.startQueue();
                (_d = (_c = this._eventManager) === null || _c === void 0 ? void 0 : _c.fire) === null || _d === void 0 ? void 0 : _d.call(_c, exports.SystemEvents.API_QUEUE_RELEASED, { reason: reason }, error);
            });
        }
        /**
         * Stop queue timer
    ...
    class Context {
        ...
        runExperience(experienceKey, attributes) {
            ...
            if (Object.values(exports.RuleError).includes(bucketedVariation))
                return bucketedVariation;
            if (Object.values(exports.BucketingError).includes(bucketedVariation))
                return bucketedVariation;
            if (bucketedVariation) {
                this._eventManager.fire(exports.SystemEvents.BUCKETING, {
        ...
        runExperiences(attributes) {
            ...
            const matchedRuleErrors = bucketedVariations.filter((match) => Object.values(exports.RuleError).includes(match));
            if (matchedRuleErrors.length)
                return matchedRuleErrors;
            // Return bucketing errors if present
            const matchedBucketingErrors = bucketedVariations.filter((match) => Object.values(exports.BucketingError).includes(match));
        ...
        runFeature(key, attributes) {
            ...
            if (Array.isArray(bucketedFeature)) {
                // Return rule errors if present
                const matchedErrors = bucketedFeature.filter((match) => Object.values(exports.RuleError).includes(match));
                ...
                if (Object.values(exports.RuleError).includes(bucketedFeature))
        ...
        runFeatures(attributes) {
            ...
            // Return rule errors if present
            const matchedErrors = bucketedFeatures.filter((match) => Object.values(exports.RuleError).includes(match));
            if (matchedErrors.length)
                return matchedErrors;
        ...
        trackConversion(goalKey, attributes) {
            ...
            if (Object.values(exports.RuleError).includes(triggred))
                return triggred;
            if (triggred) {
                this._eventManager.fire(exports.SystemEvents.CONVERSION, {
                    visitorId: this._visitorId,
                    goalKey
                }, null, true);
            }
        ...
        getConfigEntity(key, entityType) {
            if (entityType === exports.EntityType.VARIATION) {
                const experiences = this._dataManager.getEntitiesList(exports.EntityType.EXPERIENCE);
        ...
        initialize(config) {
            ...
            if (Object.prototype.hasOwnProperty.call(config, 'sdkKey') &&
                ...
                if (config.data['error']) {
                    ...
                    this._eventManager.fire(exports.SystemEvents.READY, null, null, true);
                ...
                this._eventManager.fire(exports.SystemEvents.READY, {}, new Error(ERROR_MESSAGES.SDK_OR_DATA_OBJECT_REQUIRED), true);
            }
        }
        /**
                ...
                try {
                    ...
                    if (data['error']) {
                        ...
                        this._eventManager.fire(objectNotEmpty(this._dataManager.data)
                            ? exports.SystemEvents.CONFIG_UPDATED
                            : exports.SystemEvents.READY, null, null, true);
                        if (objectNotEmpty(this._dataManager.data)) {
    ...
    class DataStoreManager {
        ...
        releaseQueue(reason) {
            ...
            (_d = (_c = this._eventManager) === null || _c === void 0 ? void 0 : _c.fire) === null || _d === void 0 ? void 0 : _d.call(_c, exports.SystemEvents.DATA_STORE_QUEUE_RELEASED, {
                reason: reason || ''
            });
        }
        stopQueue() {
    ...
    class DataManager {
            ...
            if (!locationMatched && locationProperties) {
                if (Array.isArray(experience === null || experience === void 0 ? void 0 : experience.locations) && experience.locations.length) {
                    ...
                    if (locations.length) {
                        ...
                        // Return rule errors if present
                        matchedErrors = matchedLocations.filter((match) => Object.values(exports.RuleError).includes(match));
                        if (matchedErrors.length)
                    ...
                    // Return rule errors if present
                    if (Object.values(exports.RuleError).includes(locationMatched))
            ...
            if (visitorProperties) {
                if (Array.isArray(experience === null || experience === void 0 ? void 0 : experience.audiences) && experience.audiences.length) {
                    ...
                    if (audiencesToCheck.length) {
                        ...
                        // Return rule errors if present
                        matchedErrors = matchedAudiences.filter((match) => Object.values(exports.RuleError).includes(match));
                        if (matchedErrors.length)
                            return matchedErrors[0];
        ...
        _getBucketingByField(visitorId, identity, identityField = 'key', attributes) {
            ...
            if (experience) {
                if (Object.values(exports.RuleError).includes(experience)) {
                    return experience;
                }
        ...
        _retrieveBucketing(visitorId, visitorProperties, updateVisitorProperties, experience, forceVariationId, enableTracking = true) {
            ...
            if (storedVariationId &&
                ...
                if (!variationId) {
                    ...
                    return exports.BucketingError.VARIAION_NOT_DECIDED;
                }
                ...
                for (let i = 0, length = items.length; i < length; i++) {
                    ...
                    if (match === true) {
                        ...
                        if (!locations.includes(identity) || forceEvent) {
                            this._eventManager.fire(exports.SystemEvents.LOCATION_ACTIVATED, {
                                visitorId,
                                location: {
                        ...
                        this._eventManager.fire(exports.SystemEvents.LOCATION_DEACTIVATED, {
                            visitorId,
                            location: {
        ...
        convert(visitorId, goalId, goalRule, goalData, segments, conversionSetting) {
            ...
            if (goalRule) {
                ...
                // Return rule errors if present
                if (Object.values(exports.RuleError).includes(ruleMatched))
                    return ruleMatched;
                if (!ruleMatched) {
    ...
    class ExperienceManager {
        ...
        selectVariations(visitorId, attributes) {
            return this.getList()
                ...
                !Object.values(exports.RuleError).includes(variation) &&
                !Object.values(exports.BucketingError).includes(variation));
        }
        /**
    ...
    class FeatureManager {
            ...
            if (declaredFeature) {
                ...
                if (arrayNotEmpty(features)) {
                    if (features.length === 1) {
                        ...
                        // Return rule errors if present
                        const matchedErrors = features.filter((match) => Object.values(exports.RuleError).includes(match));
                        if (matchedErrors.length)
                            return matchedErrors;
                        // Return an array of bucketed features. It means the feature is used in different experiences and visitor has been bucketed to those variations
                        return features;
        ...
        runFeatures(visitorId, attributes, filter) {
            ...
            const bucketedVariations = experiences
                ...
                if (Object.values(exports.RuleError).includes(variation))
                    return variation;
                return variation;
            })
                .filter(Boolean);
            // Return rule errors if present
            const matchedErrors = bucketedVariations.filter((match) => Object.values(exports.RuleError).includes(match));
            if (matchedErrors.length)
                return matchedErrors;
            ...
            for (const k in bucketedVariations) {
                ...
                for (const v in (bucketedVariation === null || bucketedVariation === void 0 ? void 0 : bucketedVariation.changes) || []) {
                    ...
                    if (((_d = (_c = bucketedVariation === null || bucketedVariation === void 0 ? void 0 : bucketedVariation.changes) === null || _c === void 0 ? void 0 : _c[v]) === null || _d === void 0 ? void 0 : _d.type) !==
                        exports.VariationChangeType.FULLSTACK_FEATURE) {
        ...
        isRuleMatched(data, ruleSet, logEntry) {
            ...
            if (Object.prototype.hasOwnProperty.call(ruleSet, 'OR') &&
                ...
                for (let i = 0, l = ruleSet.OR.length; i < l; i++) {
                    ...
                    if (Object.values(exports.RuleError).includes(match)) {
                                ...
                                if (rule === null || rule === void 0 ? void 0 : rule.rule_type) {
                                    ...
                                    for (const method of Object.getOwnPropertyNames(data.constructor.prototype)) {
                                        ...
                                        if (method === rule_method ||
                                            ...
                                            if (Object.values(exports.RuleError).includes(dataValue))
                                                return dataValue;
        ...
        setCustomSegments(visitorId, segments, segmentRule) {
            ...
            for (const segment of segments) {
                if (segmentRule && !segmentsMatched) {
                    ...
                    // Return rule errors if present
                    if (Object.values(exports.RuleError).includes(segmentsMatched))
     ...
     * License Apache-2.0
     */
    const DEFAULT_LOG_LEVEL = exports.LogLevel.TRACE;
    /**
    ...
    class LogManager {
        ...
        _isValidLevel(level) {
            return Object.values(exports.LogLevel).includes(level);
        }
        ...
        _log(method, level, ...args) {
            this._clients.forEach((client) => {
                var _a, _b;
                if (level >= client.level && exports.LogLevel.SILENT !== level) {
         ...
         */
        trace(...args) {
            this._log(LogMethod.TRACE, exports.LogLevel.TRACE, ...args);
        }
        /**
         * @param {Array<any>} args
         */
        debug(...args) {
            this._log(LogMethod.DEBUG, exports.LogLevel.DEBUG, ...args);
        }
        /**
         * @param {Array<any>} args
         */
        info(...args) {
            this._log(LogMethod.INFO, exports.LogLevel.INFO, ...args);
        }
        /**
         * @param {Array<any>} args
         */
        warn(...args) {
            this._log(LogMethod.WARN, exports.LogLevel.WARN, ...args);
        }
        /**
         * @param {Array<any>} args
         */
        error(...args) {
            this._log(LogMethod.ERROR, exports.LogLevel.ERROR, ...args);
        }
        /**
         * @param {any=} client
         * @param {LogLevel=} level
