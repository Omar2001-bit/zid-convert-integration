...
import { ConfigResponseData, StoreData, LocationAttributes, IdentityField, BucketingAttributes, ConfigExperience, BucketedVariation, GoalData, VisitorSegments, Entity, Config } from './types';
import { RuleError, BucketingError, ConversionSettingKey } from './enums';
...
interface DataManagerInterface {
    ...
    reset(): any;
    putData(storeKey: string, storeData: StoreData): any;
    ...
    getBucketing(visitorId: string, experienceKey: string, attributes: BucketingAttributes): BucketedVariation | RuleError | BucketingError;
    getBucketingById(visitorId: string, experienceId: string, attributes: BucketingAttributes): BucketedVariation | RuleError | BucketingError;
 ...
 */
declare class DataManager implements DataManagerInterface {
    private _data;
    private _accountId;
    private _projectId;
    private _config;
 ...
 */
declare class DataStoreManager implements DataStoreManagerInterface {
...
export { DataManager, type DataManagerInterface, DataStoreManager, type DataStoreManagerInterface };
